...
Basic WalletScript setup:
   ...
   7. As long as you have Bitcoin(alt-coin) client running and RPC set up correctly
      then you should be ready to create an account and use the wallet.

A basic security addition:

   I suggest putting the auth.php file out of the public scope and fixing the require
   lines accordingliy in index.php and wallet.php
